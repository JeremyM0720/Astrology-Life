...
/* Temporary 'More' Button Function */
...
$('.btn-submit').click(function() {
	...
	if ( $(this).closest('form').hasClass('create-campaign') ) {
		...
		var newCampaign = '<div class="campaign"><table><tr class="row-campaign"><td class="cell cell-expand btn-expand"><img src="../img/icons/icon-plus.png" class="icon-expand"><img src="../img/icons/icon-minus.png" class="icon-collapse"></td><td class="cell cell-info"><span class="campaign-id">Campaign #1</span><span class="campaign-name">' + dataName + '</span><span class="campaign-date-info">Edited on July 31, 2016 3:15 pm by you</span></td><td class="cell cell-buttons"><div class="btn btn-no-fill btn-more-options has-popup"><span class="btn-more-arrow"><img src="../img/icons/icon-circled-arrow-down.png"></span><div class="popup popup-more"><a href="#">Duplicate</a><a href="#" data-toggle="modal" data-target="#deleteModal1">Delete</a></div></div><a href="#" class="btn btn-no-fill btn-more"><span>More</span></a> <a href="#" class="btn btn-no-fill btn-schedule"><img src="../img/icons/icon-clock-2.png"><img src="../img/icons/icon-clock-2-alt.png" class="clock-alt"><span>Schedule</span></a> <a href="#" class="btn btn-no-fill btn-new-email"><span>New Email</span></a> <div href="#" class="btn btn-no-fill btn-new-sub has-popup create-campaign"><span>New Sub-Campaign</span><div class="popup popup-create-campaign prevent-parent"><p class="smaller new-campaign-id">Campaign #6</p><p class="bold normal-size">New Campaign</p><form class="create-subcampaign"><input type="text" class="new-campaign-name"><p class="align-center option-buttons new-campaign-buttons"><button class="option-1 popup-close">Cancel</button> <button class="option-2 btn-blue btn-submit">Save</button></p></form></div></div> <a href="#" class="btn-campaign-arrow"><i class="fa fa-angle-right bigger status-arrow"></i></a></td></tr><tr class="row-sub-campaign-list row-hidden"><td colspan="3"></td></tr> </table></div>';
	}
	...
	if( !dataName ) {
		...
		$('.notice-message').append('<div class="campaign-created remove-on-click"><img src="../img/icons/icon-check.png" style="margin-right: 5px;"> <span>New ' + dataCreated + ' Created</span></div>');
